...
const file_raft_proto_rawDesc = "" +
	...
	"\aentries\x18\x05 \x03(\v2\x10.distkv.LogEntryR\aentries\x12#\n" +
	...
	"\x04Raft\x12F\n" +
	"\vRequestVote\x12\x1a.distkv.RequestVoteRequest\x1a\x1b.distkv.RequestVoteResponse\x12L\n" +
	"\rAppendEntries\x12\x1c.distkv.AppendEntriesRequest\x1a\x1d.distkv.AppendEntriesResponse\x12R\n" +
	"\x0fInstallSnapshot\x12\x1e.distkv.InstallSnapshotRequest\x1a\x1f.distkv.InstallSnapshotResponseB.Z,github.com/sujalbistaa/DistKV/proto/distkvpbb\x06proto3"
...
var file_raft_proto_goTypes = []any{
	(*LogEntry)(nil),                // 0: distkv.LogEntry
	(*RequestVoteRequest)(nil),      // 1: distkv.RequestVoteRequest
	(*RequestVoteResponse)(nil),     // 2: distkv.RequestVoteResponse
	(*AppendEntriesRequest)(nil),    // 3: distkv.AppendEntriesRequest
	(*AppendEntriesResponse)(nil),   // 4: distkv.AppendEntriesResponse
	(*InstallSnapshotRequest)(nil),  // 5: distkv.InstallSnapshotRequest
	(*InstallSnapshotResponse)(nil), // 6: distkv.InstallSnapshotResponse
}
var file_raft_proto_depIdxs = []int32{
	0, // 0: distkv.AppendEntriesRequest.entries:type_name -> distkv.LogEntry
	1, // 1: distkv.Raft.RequestVote:input_type -> distkv.RequestVoteRequest
	3, // 2: distkv.Raft.AppendEntries:input_type -> distkv.AppendEntriesRequest
	5, // 3: distkv.Raft.InstallSnapshot:input_type -> distkv.InstallSnapshotRequest
	2, // 4: distkv.Raft.RequestVote:output_type -> distkv.RequestVoteResponse
	4, // 5: distkv.Raft.AppendEntries:output_type -> distkv.AppendEntriesResponse
	6, // 6: distkv.Raft.InstallSnapshot:output_type -> distkv.InstallSnapshotResponse

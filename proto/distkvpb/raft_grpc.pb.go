...
const (
	Raft_RequestVote_FullMethodName     = "/distkv.Raft/RequestVote"
	Raft_AppendEntries_FullMethodName   = "/distkv.Raft/AppendEntries"
	Raft_InstallSnapshot_FullMethodName = "/distkv.Raft/InstallSnapshot"
)
